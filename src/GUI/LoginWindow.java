...
public class LoginWindow extends JFrame implements ActionListener, KeyListener
{
	...
	{		
		...
		boolean message = Login.login(login.getText(), tempP);
		//if successful, open the main window and close this one
		if(message)
		{
			System.out.println("Login successful");
			MainWindow mainWindow = new MainWindow(LoadAppointmentsDB.loadList(login.getText()), login.getText());
			dispose();
