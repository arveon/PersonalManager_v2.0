...
public class MainWindow extends JFrame
{
	 ...
	 */
	public MainWindow(AppointmentList list, String username)
	{
		user = username;
		this.list = list;
...
//used for testing and displayes all the appointments in the console
//		constr.gridx = 0;
//		JButton showall = new JButton("Show all");
//		showall.addActionListener(new MainActionListener(this));
//		content.add(showall, constr);
	...
	public void save()
	{
		...
		SaveAppointmentsDB.saveApps(list, user);
		//boolean success = ListLoader.saveList(list, user);
		if(success)
		{
	...
	public class MainActionListener implements ActionListener 
	{
		...
		{
			//JButton asd = (JButton)event.getSource();
...
//used for testing and displayes all the appointments in the console
//			else if(asd.getText().equals("Show all"))
//			{
//				list.printAllAppointments();;
//			}
		}
